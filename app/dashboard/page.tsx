  ...
  return (
    <section className="flex min-h-[calc(100vh-10rem)] items-center justify-center">
      <div className="w-full max-w-2xl rounded-xl border bg-card px-6 py-16 text-center shadow-sm sm:px-12">
        ...
        <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-muted-foreground">Área de gestão</p>
        <h1 className="text-3xl font-bold tracking-[-0.05em] text-foreground sm:text-4xl">Bem-vindo ao izi Freelas</h1>
